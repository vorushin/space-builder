/**
 * Space Builder - Main Game File (Modular Version)
 * Imports configuration and utilities from ES6 modules
 */
...
async function init() {
    ...
    // Note: LEVEL_CONFIG is now imported from src/config/levels.js
    // Note: Constants are imported from src/config/constants.js
    ...
    // Note: checkCollision is now imported from src/utils/collision.js
